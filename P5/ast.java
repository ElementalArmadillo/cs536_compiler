...
class ExpListNode extends ASTnode {
    ...
    public void typeCheck(List<Type> paramTypes) {
...
class FnDeclNode extends DeclNode {
    ...
    public void typeCheck() {
        myBody.typeCheck(myType.type()); //pass down function type, check at return stmt
    }
...
abstract class StmtNode extends ASTnode {
    ...
    abstract public void typeCheck(Type fnType);
}
...
class ReturnStmtNode extends StmtNode {
    ...
    public void typeCheck(Type fnType) {
        if (myExp == null) {
            ...
            if (expType.isErrorType() || fnType.isErrorType()) {
                return;
            }

            if (!expType.equals(fnType)){
...
class IntLitNode extends ExpNode {
    ...
    /**
     * Return the line number for this node.
     */
    public int lineNum() {
        return myLineNum;
    }
    ...
    /**
     * Return the char number for this node.
     */
    public int charNum() {
        return myCharNum;
    }
...
class CallExpNode extends ExpNode {
    ...
    public Type typeCheck() {
        ...
        myExpList.typeCheck(fnSym.getParamTypes()); //pass down param types
                                                    //check if they are equal to arg types
        return fnSym.getReturnType();
    }
...
abstract class LogicExpNode extends BinaryExpNode {
    public LogicExpNode(ExpNode exp1, ExpNode exp2) {
        super(exp1, exp2);
    }
    ...
    public Type typeCheck() {
        ...
        Type finalType = new BoolType();

        if (!expType1.isBoolType() && !expType1.isErrorType()) {
            ErrMsg.fatal(myExp1.lineNum(), myExp1.charNum(), "Logical operator applied to non-bool operand");
            finalType = new ErrorType();
        }

        if (!expType2.isBoolType() && !expType2.isErrorType()) {
...
abstract class MathExpNode extends BinaryExpNode {
    public MathExpNode(ExpNode exp1, ExpNode exp2) {
        super(exp1, exp2);
    }
...
abstract class ComparisonExpNode extends BinaryExpNode {
    public ComparisonExpNode(ExpNode exp1, ExpNode exp2) {
        super(exp1, exp2);
    }
...
class PlusNode extends MathExpNode {
...
class MinusNode extends MathExpNode {
...
class TimesNode extends MathExpNode {
...
class DivideNode extends MathExpNode {
...
class AndNode extends LogicExpNode {
...
class OrNode extends LogicExpNode {
...
class LessNode extends ComparisonExpNode {
...
class GreaterNode extends ComparisonExpNode {
...
class LessEqNode extends ComparisonExpNode {
...
class GreaterEqNode extends ComparisonExpNode {
